...
public value class ImmutableShortArray @PublishedApi internal constructor(
    ...
    public inline fun filterIndexed(
        crossinline predicate: (index: Int, element: Short) -> Boolean,
    ): ImmutableShortArray {
        if (isEmpty()) return this
     ...
     */
    @PublishedApi
    internal fun select(selection: Selection): ImmutableShortArray {
    ...
    public fun partition(predicate: (element: Short) -> Boolean): Pair<ImmutableShortArray, ImmutableShortArray> {
        ...
        val first = ShortArray(numSelectedElements)
        var firstIndex = 0
        selection.forEachSelectedIndex { originalIndex ->
            first[firstIndex++] = values[originalIndex]
        }

        val second = ShortArray(size - numSelectedElements)
        var secondIndex = 0
        selection.forEachUnselectedIndex { originalIndex ->
            second[secondIndex++] = values[originalIndex]
        }
        return Pair(ImmutableShortArray(first), ImmutableShortArray(second))
    }
     ...
     */
    public inline fun <R : Comparable<R>> minBy(selector: (element: Short) -> R): Short {
     ...
     * @throws NoSuchElementException if this ImmutableShortArray is empty
     */
    public inline fun <R : Comparable<R>> maxBy(selector: (element: Short) -> R): Short {
     ...
     */
    public inline fun <R : Comparable<R>> maxByOrNull(selector: (element: Short) -> R): Short? {
     ...
     * @throws NoSuchElementException if this ImmutableShortArray is empty
     */
    public fun minWith(comparator: Comparator<in Short>): Short {
        var minElement = first()
        if (size == 1) return minElement
     ...
     */
    public fun minWithOrNull(comparator: Comparator<in Short>): Short? {
     ...
     */
    public fun maxWithOrNull(comparator: Comparator<in Short>): Short? {
    ...
    /**
     * Leaves this Immutable Array as is and returns an [ImmutableShortArray] with all elements shuffled.
     */
    public fun shuffled(): ImmutableShortArray {
        if (size <= 1) return this
     ...
     * Leaves this Immutable Array as is and returns an [ImmutableShortArray] with all elements shuffled.
     */
    public fun shuffled(random: Random): ImmutableShortArray {
        if (size <= 1) return this
    ...
    public companion object {
        ...
        /**
         * Returns an ImmutableShortArray instance of the specified [size], where each element is calculated by
        ...
        /**
         * Returns an ImmutableShortArray with the first [size] elements copied from [source] starting from [startIndex].
         */
        public fun copyFrom(
            source: ShortArray,
            startIndex: Int,
