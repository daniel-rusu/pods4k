...
public value class ImmutableIntArray @PublishedApi internal constructor(
     ...
     *
     * Note that [ImmutableIntArray] stores primitive values whereas [List] operates on generic
     ...
     */
    public inline fun asList(): List<Int> = values.asList()
     ...
     */
    public fun partition(predicate: (element: Int) -> Boolean):
            Pair<ImmutableIntArray, ImmutableIntArray> {
        val first = Builder()
        val second = Builder()
    ...
    public inline fun <R : Comparable<R>> sortedByDescending(crossinline
            selector: (element: Int) -> R?): ImmutableIntArray =
