...
public value class ImmutableIntArray @PublishedApi internal constructor(
     ...
     */
    @PublishedApi
    internal fun populateBitmap(bitmap: IntArray, predicate: (index: Int, element: Int) -> Boolean): Int {
        var numOneBits = 0
     ...
     */
    @PublishedApi
    internal fun select(bitmap: IntArray, numOneBits: Int): ImmutableIntArray {
        if (numOneBits == 0) return EMPTY
        if (numOneBits == size) return this

        val result = IntArray(numOneBits)
        var resultIndex = 0
        var originalIndex = 0
