 ...
 */
@OverloadResolutionByLambdaReturnType
public inline fun <T> ImmutableArray<T>.map(transform: (element: T) -> Boolean):
        ImmutableBooleanArray = ImmutableBooleanArray(size) { transform(get(it)) }
 ...
 */
@OverloadResolutionByLambdaReturnType
public inline fun <R> ImmutableBooleanArray.map(transform: (element: Boolean) -> R):
        ImmutableArray<R> = ImmutableArray(size) { transform(get(it)) }

/**
 * Returns an immutable array containing the results of applying [transform] to each element.
 */
@OverloadResolutionByLambdaReturnType
public inline fun ImmutableBooleanArray.map(transform: (element: Boolean) -> Boolean):
        ImmutableBooleanArray = ImmutableBooleanArray(size) { transform(get(it)) }
 ...
 */
@OverloadResolutionByLambdaReturnType
public inline fun ImmutableBooleanArray.map(transform: (element: Boolean) -> Byte):
        ImmutableByteArray = ImmutableByteArray(size) { transform(get(it)) }

/**
 * Returns an immutable array containing the results of applying [transform] to each element.
 */
@OverloadResolutionByLambdaReturnType
public inline fun ImmutableBooleanArray.map(transform: (element: Boolean) -> Char):
        ImmutableCharArray = ImmutableCharArray(size) { transform(get(it)) }

/**
 * Returns an immutable array containing the results of applying [transform] to each element.
 */
@OverloadResolutionByLambdaReturnType
public inline fun ImmutableBooleanArray.map(transform: (element: Boolean) -> Short):
        ImmutableShortArray = ImmutableShortArray(size) { transform(get(it)) }
 ...
 */
@OverloadResolutionByLambdaReturnType
public inline fun ImmutableBooleanArray.map(transform: (element: Boolean) -> Long):
        ImmutableLongArray = ImmutableLongArray(size) { transform(get(it)) }

/**
 * Returns an immutable array containing the results of applying [transform] to each element.
 */
@OverloadResolutionByLambdaReturnType
public inline fun ImmutableBooleanArray.map(transform: (element: Boolean) -> Float):
        ImmutableFloatArray = ImmutableFloatArray(size) { transform(get(it)) }

/**
 * Returns an immutable array containing the results of applying [transform] to each element.
 */
@OverloadResolutionByLambdaReturnType
public inline fun ImmutableBooleanArray.map(transform: (element: Boolean) -> Double):
        ImmutableDoubleArray = ImmutableDoubleArray(size) { transform(get(it)) }
 ...
 */
@OverloadResolutionByLambdaReturnType
public inline fun ImmutableByteArray.map(transform: (element: Byte) -> Boolean):
        ImmutableBooleanArray = ImmutableBooleanArray(size) { transform(get(it)) }
 ...
 */
@OverloadResolutionByLambdaReturnType
public inline fun ImmutableCharArray.map(transform: (element: Char) -> Boolean):
        ImmutableBooleanArray = ImmutableBooleanArray(size) { transform(get(it)) }
 ...
 */
@OverloadResolutionByLambdaReturnType
public inline fun ImmutableShortArray.map(transform: (element: Short) -> Boolean):
        ImmutableBooleanArray = ImmutableBooleanArray(size) { transform(get(it)) }
 ...
 */
@OverloadResolutionByLambdaReturnType
public inline fun ImmutableShortArray.map(transform: (element: Short) -> Double):
        ImmutableDoubleArray = ImmutableDoubleArray(size) { transform(get(it)) }
 ...
 */
@OverloadResolutionByLambdaReturnType
public inline fun ImmutableLongArray.map(transform: (element: Long) -> Boolean):
        ImmutableBooleanArray = ImmutableBooleanArray(size) { transform(get(it)) }
 ...
 */
@OverloadResolutionByLambdaReturnType
public inline fun ImmutableFloatArray.map(transform: (element: Float) -> Boolean):
        ImmutableBooleanArray = ImmutableBooleanArray(size) { transform(get(it)) }
 ...
 */
@OverloadResolutionByLambdaReturnType
public inline fun ImmutableFloatArray.map(transform: (element: Float) -> Double):
        ImmutableDoubleArray = ImmutableDoubleArray(size) { transform(get(it)) }
 ...
 */
@OverloadResolutionByLambdaReturnType
public inline fun ImmutableDoubleArray.map(transform: (element: Double) -> Boolean):
        ImmutableBooleanArray = ImmutableBooleanArray(size) { transform(get(it)) }
 ...
 */
@OverloadResolutionByLambdaReturnType
public inline fun ImmutableDoubleArray.map(transform: (element: Double) -> Short):
        ImmutableShortArray = ImmutableShortArray(size) { transform(get(it)) }
 ...
 */
@OverloadResolutionByLambdaReturnType
public inline fun ImmutableDoubleArray.map(transform: (element: Double) -> Float):
        ImmutableFloatArray = ImmutableFloatArray(size) { transform(get(it)) }
 ...
 */
@OverloadResolutionByLambdaReturnType
public inline fun ImmutableDoubleArray.map(transform: (element: Double) -> Double):
        ImmutableDoubleArray = ImmutableDoubleArray(size) { transform(get(it)) }
