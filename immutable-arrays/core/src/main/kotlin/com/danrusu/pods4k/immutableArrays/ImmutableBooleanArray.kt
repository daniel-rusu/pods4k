...
public value class ImmutableBooleanArray @PublishedApi internal constructor(
     ...
     */
    public fun referencesSameArrayAs(other: ImmutableBooleanArray): Boolean {
     ...
     */
    public inline operator fun iterator(): BooleanIterator = values.iterator()
     ...
     */
    public fun chunked(size: Int): ImmutableArray<ImmutableBooleanArray> {
    ...
    ): ImmutableArray<ImmutableBooleanArray> {
     ...
     */
    @PublishedApi
    internal fun select(selection: Selection): ImmutableBooleanArray {
    ...
    public fun partition(predicate: (element: Boolean) -> Boolean): Pair<ImmutableBooleanArray, ImmutableBooleanArray> {
        ...
        val first = BooleanArray(numSelectedElements)
        var firstIndex = 0
        selection.forEachSelectedIndex { originalIndex ->
            first[firstIndex++] = values[originalIndex]
        }

        val second = BooleanArray(size - numSelectedElements)
        var secondIndex = 0
        selection.forEachUnselectedIndex { originalIndex ->
            second[secondIndex++] = values[originalIndex]
        }
        return Pair(ImmutableBooleanArray(first), ImmutableBooleanArray(second))
    }
     ...
     */
    public inline fun <R : Comparable<R>> minBy(selector: (element: Boolean) -> R): Boolean {
     ...
     * @throws NoSuchElementException if this ImmutableBooleanArray is empty
     */
    public inline fun <R : Comparable<R>> maxBy(selector: (element: Boolean) -> R): Boolean {
     ...
     */
    public fun minWithOrNull(comparator: Comparator<in Boolean>): Boolean? {
     ...
     * @throws NoSuchElementException if this ImmutableBooleanArray is empty
     */
    public fun maxWith(comparator: Comparator<in Boolean>): Boolean {
        var maxElement = first()
        if (size == 1) return maxElement
     ...
     */
    public fun maxWithOrNull(comparator: Comparator<in Boolean>): Boolean? {
    ...
    public inline fun <R : Comparable<R>> sortedBy(
        crossinline selector: (element: Boolean) -> R?,
    ): ImmutableBooleanArray {
    ...
    /**
     * Leaves this Immutable Array as is and returns an [ImmutableBooleanArray] with all elements shuffled.
     */
    ...
    public fun distinct(): ImmutableBooleanArray {
        ...
        val distinctValues = HashSet<Boolean>()
    ...
    public companion object {
        ...
        /**
         * Returns an ImmutableBooleanArray instance of the specified [size], where each element is calculated by
        ...
        /**
         * Returns an ImmutableBooleanArray with the first [size] elements copied from [source] starting from [startIndex].
         */
        public fun copyFrom(
            source: BooleanArray,
            startIndex: Int,
