...
public value class ImmutableCharArray @PublishedApi internal constructor(
     ...
     */
    public fun chunked(size: Int): ImmutableArray<ImmutableCharArray> {
    ...
    ): ImmutableArray<ImmutableCharArray> {
     ...
     */
    @PublishedApi
    internal fun select(selection: Selection): ImmutableCharArray {
    ...
    public fun partition(predicate: (element: Char) -> Boolean): Pair<ImmutableCharArray, ImmutableCharArray> {
        ...
        val first = CharArray(numSelectedElements)
        var firstIndex = 0
        selection.forEachSelectedIndex { originalIndex ->
            first[firstIndex++] = values[originalIndex]
        }

        val second = CharArray(size - numSelectedElements)
        var secondIndex = 0
        selection.forEachUnselectedIndex { originalIndex ->
            second[secondIndex++] = values[originalIndex]
        }
        return Pair(ImmutableCharArray(first), ImmutableCharArray(second))
    }
