...
public value class ImmutableLongArray @PublishedApi internal constructor(
     ...
     */
    public fun referencesSameArrayAs(other: ImmutableLongArray): Boolean {
    ...
    /**
     * See [LongArray.randomOrNull]
     */
    public inline fun randomOrNull(): Long? = values.randomOrNull()

    /**
     * See [LongArray.randomOrNull]
     */
    public inline fun randomOrNull(random: Random): Long? = values.randomOrNull(random)
     ...
     */
    public fun chunked(size: Int): ImmutableArray<ImmutableLongArray> {
    ...
    public inline fun sumOf(selector: (element: Long) -> Int): Int = values.sumOf(selector)

    /**
     * See [LongArray.sumOf]
     */
    @OverloadResolutionByLambdaReturnType
    public inline fun sumOf(selector: (element: Long) -> Long): Long = values.sumOf(selector)
     ...
     */
    public inline fun takeWhile(predicate: (element: Long) -> Boolean): ImmutableLongArray {
     ...
     */
    public inline fun takeLastWhile(predicate: (element: Long) -> Boolean): ImmutableLongArray {
     ...
     * @throws IllegalArgumentException if [n] is negative.
     */
    public fun drop(n: Int): ImmutableLongArray {
        require(n >= 0) { "Requested element count $n is less than zero." }
     ...
     * @throws IllegalArgumentException if [n] is negative.
     */
    public fun dropLast(n: Int): ImmutableLongArray {
        require(n >= 0) { "Requested element count $n is less than zero." }
     ...
     */
    public inline fun dropLastWhile(predicate: (element: Long) -> Boolean): ImmutableLongArray {
        for (index in lastIndex downTo 0) {
            if (!predicate(values[index])) {
                return take(index + 1)
            }
     ...
     * Returns an Immutable Array containing only the elements matching the given [predicate].
     */
    public inline fun filterIndexed(crossinline predicate: (index: Int, element: Long) -> Boolean): ImmutableLongArray {
        if (isEmpty()) return this
     ...
     */
    @PublishedApi
    internal fun select(selection: Selection): ImmutableLongArray {
    ...
    public fun partition(predicate: (element: Long) -> Boolean): Pair<ImmutableLongArray, ImmutableLongArray> {
        ...
        val first = LongArray(numSelectedElements)
        var firstIndex = 0
        selection.forEachSelectedIndex { originalIndex ->
            first[firstIndex++] = values[originalIndex]
        }

        val second = LongArray(size - numSelectedElements)
        var secondIndex = 0
        selection.forEachUnselectedIndex { originalIndex ->
            second[secondIndex++] = values[originalIndex]
        }
        return Pair(ImmutableLongArray(first), ImmutableLongArray(second))
    }
     ...
     */
    public inline fun <R : Comparable<R>> minBy(selector: (element: Long) -> R): Long {
     ...
     * @throws NoSuchElementException if this ImmutableLongArray is empty
     */
    public inline fun <R : Comparable<R>> maxBy(selector: (element: Long) -> R): Long {
     ...
     */
    public inline fun <R : Comparable<R>> maxByOrNull(selector: (element: Long) -> R): Long? {
     ...
     * @throws NoSuchElementException if this ImmutableLongArray is empty
     */
    public fun minWith(comparator: Comparator<in Long>): Long {
        var minElement = first()
        if (size == 1) return minElement
     ...
     */
    public fun minWithOrNull(comparator: Comparator<in Long>): Long? {
     ...
     * @throws NoSuchElementException if this ImmutableLongArray is empty
     */
    public fun maxWith(comparator: Comparator<in Long>): Long {
        var maxElement = first()
        if (size == 1) return maxElement
     ...
     */
    public fun maxWithOrNull(comparator: Comparator<in Long>): Long? {
    ...
    public inline fun <R : Comparable<R>> sortedByDescending(
        crossinline selector: (element: Long) -> R?,
    ): ImmutableLongArray {
    ...
    /**
     * Leaves this Immutable Array as is and returns an [ImmutableLongArray] with all elements shuffled.
     */
     ...
     * Leaves this Immutable Array as is and returns an [ImmutableLongArray] with all elements shuffled.
     */
    public fun shuffled(random: Random): ImmutableLongArray {
        if (size <= 1) return this
    ...
    public companion object {
        ...
        /**
         * Returns an ImmutableLongArray instance of the specified [size], where each element is calculated by
        ...
        /**
         * Returns an ImmutableLongArray with the first [size] elements copied from [source] starting from [startIndex].
         */
        public fun copyFrom(
            source: LongArray,
            startIndex: Int,
