...
public value class ImmutableLongArray @PublishedApi internal constructor(
     ...
     */
    @PublishedApi
    internal fun populateBitmap(bitmap: IntArray, predicate: (index: Int, element: Long) -> Boolean): Int {
        var numOneBits = 0
     ...
     */
    @PublishedApi
    internal fun select(bitmap: IntArray, numOneBits: Int): ImmutableLongArray {
