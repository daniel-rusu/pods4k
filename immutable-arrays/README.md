...
* **Fast**
    * 2 to 8 times faster for many common operations, with some even faster!
* **Type Safety**
    * Compile-time checks prevent accidental mutation attempts.
...
wrapper objects face higher memory latency.
