...
Note that these benchmarks use like-for-like comparisons with regular arrays (eg. `ImmutableFloatArray` vs.
`FloatArray`). The [Benchmarks page](BENCHMARKS.md) includes explanations of why Immutable Arrays achieve seemingly
