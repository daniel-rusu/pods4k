...
Immutable Arrays automatically use primitives without having to think about it. For example:

```kotlin
// returns primitive Immutable Array when `weightKg` is a primitive type
